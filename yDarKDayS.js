...
client.user.setActivity(`+yardım`, { type: "PLAYING" });
  console.log("Bot Aktif Kullanıma Hazır");
});
...
`)
  .addField('** Uptime Bot Yardım Menüsü **',`
- **u!ekle (glitch show linki)** = Botunuzu 7/24 Aktif Tutar.
- **u!linkler** = 7/24 Tuttuğum linklerini gösterir.
- **u!say** = Tüm Uptime edilmiş bot sayısını gösterir.
`)
  .addField('------------------------------------------------------',`
[Destek Sunucu](https://discord.gg/zZXZWaptFX)
[Botu Davet Et](https://discord.com/oauth2/authorize?client_id=709483249361223711&scope=bot&permissions=805314622)`)
 ...
 [Destek Sunucu](https://discord.gg/zZXZWaptFX)`).setThumbnail(message.author.avatarURL))
    }
...
client.on('ready', () => {
client.user.setActivity(`u!ekle (Kısa Link)`, { type: 'PLAYING' })
